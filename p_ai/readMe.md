...
이 프로젝트는 Spring Boot 기반의 Chatbot 시스템을 구축하는 과정에서 프론트엔드의 React 마이그레이션, Flask API 연동, AWS 배포 및 CI/CD 적용 등을 포함한 실무에 가까운 설계 및 운영 경험을 쌓는 것을 목표로 한다.

(설계상의 시행착오 및 개선 과정은 `docs/` 디렉토리에 정리할 것.)
...
사소한 시행착오 및 문제 해결 과정은 별도의 문서로 정리할 예정입니다.
