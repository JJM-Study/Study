...
<style>
  ...
  .button {cursor:pointer; height: 3em; font-size: 1em; background: rgb(185, 218, 185); border-radius:0.2em; border: 0.1em solid; width : 7em; margin-right: 2em;}
...
<body>
     <div id = "div_collection">
      <h1>Sing Up</h1>
       <form action="singUp" method="post" id="form">
        <div>
          <p><label for="input_name">NAME</label></p>
          <input id="input_name" type="text" name="name" placeholder="Enter Your Name"></input>
        </div>
        <div>
          <p><label for="input_email">EMAIL</label></p>
          <input id="input_email" type="email" name="email" placeholder="Enter Your Email"></input>
        </div>
        <div>
        ...
        <div id="div_btn">
          <input type="button" id="btn_signUp" class="button" onclick="singUp()" value="Sing Up"></input>
          <input type="reset" onclick="" value="Reset" class="button"></input>
        </div>
       </form>
     </div>
    ...
    <script>
      ...
      var reg_email = /^([0-9a-zA-Z_\.-]+)@([0-9a-zA-Z_-]+)(\.[0-9a-zA-Z_-]+){1,2}$/;
    	...
    	function singUp()
    	{
	        ...
	        //var checkpopup = window.open("${contextPath}/checkId?id=" + input_id.value);
